...
🧠 How It Works
Train on normal data only → Model learns what “normal” looks like.
Generate reconstructed image → G tries to reproduce input.
Compute anomaly map → Difference = possible defect region.
Evaluate and visualize → Red regions = higher anomaly score.
📊 Results
...
📚 Citations
Goodfellow, I. et al. (2014). Generative Adversarial Nets, NeurIPS. 📄 Paper
Bergmann, P. et al. (2019). MVTec AD Dataset, CVPR. 📄 Paper
Schlegl, T. et al. (2017). Unsupervised Anomaly Detection with GANs, IPMI. 📄 Paper
🧑‍💻 Author
Yasesh Chandra
